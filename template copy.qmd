...
### Creating One Large Dataset That Combines all Temp Dat
```{julia}
combined_temp_time = cat(temp10_time, temp11_time, temp12_time, temp13_time, temp14_time, temp15_time, temp16_time, temp17_time, temp18_time, temp19_time, temp20_time, dims=1)
```
```{julia}
combined_temp = cat(temp10, temp11, temp12, temp13, temp14, temp15, temp16, temp17, temp18, temp19, temp20, dims=3)
```

### Converting Times to Daily Instead of Hourly
```{julia}
